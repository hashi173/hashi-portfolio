...
const About: React.FC = () => {
  return (
    <div id="philosophy" className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row gap-12 relative overflow-hidden">
      ...
      <div className="w-full md:w-1/2 relative z-10">
        <motion.h3
          ...
          viewport={{ once: true }}
          className="text-[#D4AF37] text-xs uppercase tracking-[1em] mb-3"
        >
          Philosophy
        </motion.h3>
        ...
        <motion.h2
          ...
          className="text-white text-5xl md:text-8xl font-['Shippori_Mincho'] italic mb-6 leading-tight"
        >
          The <br /><span className="text-[#D4AF37]">Balance</span>
        </motion.h2>

        <div className="space-y-4 text-white/70 font-['Shippori_Mincho'] text-lg md:text-sm leading-relaxed max-w-lg">
          <motion.p
            initial={{ opacity: 0 }}
          ...
          <motion.p
            ...
            className="text-white italic border-l border-[#D4AF37]/50 pl-3 py-2 bg-white/5"
          >
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center relative z-10">
        ...
        {/* Atmosphere Graphic */}
        <div className="mt-16 aspect-square relative rounded-full border border-white/5 overflow-hidden flex items-center justify-center group self-center w-32 md:w-40">
          <motion.div
            animate={{ rotate: 360 }}
