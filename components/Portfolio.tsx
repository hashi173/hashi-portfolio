...
const Portfolio: React.FC = () => {
  return (
    <div id="portfolio" className="container mx-auto px-4 md:px-8">
      <div className="mb-12">
        <h3 className="text-cyan-400 text-xs uppercase tracking-[1em] mb-2">Case Studies</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        {PROJECTS.map((project, index) => (
          <motion.div
            ...
            className={`relative group ${index % 2 !== 0 ? 'md:translate-y-12' : ''}`}
          >
            {/* Project Card */}
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-[#0B1015] border border-white/5 backdrop-blur-sm transition-all duration-700 group-hover:border-cyan-400/50">
              ...
              <div className="absolute right-3 top-3 vertical-rl text-black text-sm font-['Shippori_Mincho'] opacity-0 group-hover:opacity-100 transition-opacity duration-700">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                ...
                <h4 className="text-white text-3xl font-bold font-['Zen_Kaku_Gothic_New'] mb-1">{project.title}</h4>
                ...
                <motion.a
                  ...
                  whileHover={{ x: 10 }}
                  className="mt-3 flex items-center text-[10px] uppercase tracking-widest text-white border-b border-white/20 pb-1 hover:border-cyan-400 transition-colors inline-block"
                >
      ...
      <div className="mt-24 flex justify-center">
        <motion.a
          ...
          className="group relative px-6 py-3 border border-white/10 hover:border-cyan-400/50 transition-colors inline-block"
        >
