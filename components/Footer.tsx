...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="relative w-full bg-[#FDFCF8] pt-24 pb-12 px-4 md:px-8 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 text-center">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-[#2E4057] text-6xl md:text-9xl font-['Shippori_Mincho'] italic mb-6">
            Let's build the <br /> bridge together.
          </h2>

          <a
            href="mailto:phamthithienha17032005@gmail.com"
            className="inline-block text-[#2E4057] text-3xl md:text-3xl font-['Shippori_Mincho'] border-b-2 border-[#2E4057]/10 hover:border-[#D4AF37] transition-all duration-500 mb-6"
          >
          ...
          <div className="flex justify-center space-x-4">
            {[
              ...
              <motion.a
                ...
                className="w-8 h-8 flex items-center justify-center border-2 border-red-700 text-red-700 font-bold font-serif text-sm relative group"
        ...
        <div className="flex flex-col justify-center items-center border-t border-[#2E4057]/10 pt-8">
      ...
      <div className="absolute bottom-6 right-6 text-[7.5rem] font-['Shippori_Mincho'] text-[#2E4057]/5 select-none pointer-events-none -z-10">
        橋
      </div>
    </footer>
  );
